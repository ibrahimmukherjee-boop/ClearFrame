...
API_HOST = os.environ.get("CLEARFRAME_API_HOST", "127.0.0.1")
API_PORT = int(os.environ.get("CLEARFRAME_API_PORT", "8080"))
CORS_ORIGINS = os.environ.get("CLEARFRAME_CORS", "http://localhost:5173,http://127.0.0.1:5173").split(",")
...
CF_OPS_TOKEN_PATH = Path(os.path.expanduser("~/.clearframe/ops-token"))
